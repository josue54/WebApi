...
-Using console logs and system.debug to check the respective outputs
2. How long did it take you to complete the task?
-arround 3 hours for the controller an additional hour for database plus 30 minutes to index javascript
3. What else could be done to your solution to make it ready for production?
-for testing purposes im using embeded resource for database but for prod settings its better to use a dependency injecion referencing the data.db in appsettings.json
-for testing purposes cors its allowing all origins , for prod purposes its better to set correctly the Cors policy 
